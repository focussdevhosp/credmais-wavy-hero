...
import consultoriaAsset from '@/assets/consultoria-card-reconstructed.png.asset.json';
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div
            ...
            className="relative"
          >
            {/* O container principal que agora apenas exibe a imagem reconstruída de alta fidelidade */}
            <div className="rounded-[32px] sm:rounded-[60px] overflow-hidden shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)] border border-navy/5">
              <img 
