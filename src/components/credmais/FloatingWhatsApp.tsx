...
export function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 shadow-2xl shadow-black/20 transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-[0_8px_30px_rgba(37,211,102,0.4)] active:scale-95"
    >
