...
function AntecipacaoPage() {
  return (
    <div className="min-h-screen bg-ice">
      ...
      <section className="relative min-h-[70vh] lg:min-h-[90vh] flex items-center overflow-hidden pt-28 pb-16 sm:pt-32 lg:pt-20 lg:pb-0">
        <div className="container mx-auto px-5 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center relative z-10">
          <motion.div
          ...
          >
            ...
            <p className="text-navy/70 text-base sm:text-lg lg:text-xl font-light max-w-lg mb-8 sm:mb-10 leading-relaxed">
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="rounded-[32px] sm:rounded-[60px] overflow-hidden shadow-[0_50px_100px_-20px_rgba(7,26,51,0.3)] border border-white/20">
              <img 
        ...
        {/* Background Elements */}
        <div className="absolute top-0 right-0 w-1/2 h-full bg-navy/5 -skew-x-12 translate-x-1/3 -z-0 pointer-events-none hidden sm:block" />
      </section>

      {/* Stats Bar */}
      <section className="bg-navy py-12">
        <div className="container mx-auto px-5 sm:px-6 grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
          {[
            ...
            <div key={i} className="text-center border-white/10 sm:border-r sm:last:border-0">
              <div className="text-gold font-bold text-2xl sm:text-3xl mb-1">{stat.value}</div>
              <div className="text-white/40 text-[10px] sm:text-xs uppercase tracking-widest">{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 lg:py-40">
        <div className="container mx-auto px-5 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center">
            ...
            >
              <div className="rounded-[32px] sm:rounded-[60px] overflow-hidden shadow-2xl">
        ...
        <div className="container mx-auto px-5 sm:px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <div className="rounded-[32px] sm:rounded-[60px] overflow-hidden shadow-2xl lg:rotate-2 hover:rotate-0 transition-transform duration-700">
      ...
      {/* Z-Pattern Features */}
      <section className="py-16 sm:py-24 lg:py-40">
        <div className="container mx-auto px-5 sm:px-6 space-y-16 sm:space-y-28 lg:space-y-40">
          {/* Item 1 */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-14 lg:gap-20 items-center">
            <div className="lg:pr-12">
              <h3 className="text-[clamp(1.5rem,5vw,1.875rem)] font-heading font-light text-navy mb-5 sm:mb-6 leading-tight">
                Mais previsibilidade para <span className="font-bold italic">planejar.</span>
              </h3>
              <p className="text-navy/70 text-base sm:text-lg font-light leading-relaxed">
      ...
      {/* Expert Support */}
      <section className="bg-ice py-16 sm:py-24 lg:py-40">
        <div className="container mx-auto px-5 sm:px-6">
          <div className="bg-white rounded-[32px] sm:rounded-[60px] p-6 sm:p-10 lg:p-20 shadow-2xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-[clamp(1.75rem,6vw,3rem)] font-heading font-light text-navy mb-6 sm:mb-8 leading-tight">
            ...
            <div className="relative">
              ...
              <div className="absolute inset-0 border-[10px] sm:border-[20px] border-ice rounded-[40px] pointer-events-none" />
            </div>
          </div>
        </div>
      </section>
